...
public class CameraMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Quaternion cameraRotation = followTarget.transform.localRotation *= Quaternion.AngleAxis(playerController.Look.x * appliedXSens * invertX * Time.deltaTime, Vector3.up);
