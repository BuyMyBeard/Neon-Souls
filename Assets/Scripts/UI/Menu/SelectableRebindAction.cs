...
public class SelectableRebindAction : Selectable, ISubmitHandler, IPointerClickHandler, IResetableRemap
{
    ...
    [Serializable]
    public class UpdateBindingUIEvent : UnityEvent<SelectableRebindAction, string, string, string>
    {
    }

    [Serializable]
    public class InteractiveRebindEvent : UnityEvent<SelectableRebindAction, InputActionRebindingExtensions.RebindingOperation>
    {
    }
}
